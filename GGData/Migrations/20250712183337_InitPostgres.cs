        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebsiteProfissional = table.Column<string>(type: "text", nullable: true),
                    DescricaoProfissional = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comentarios = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    DataReview = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TipoUsuario = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EstatisticaId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Conquistas = table.Column<string>(type: "text", nullable: false),
                    TempoMedioJogo = table.Column<decimal>(type: "numeric", nullable: false),
                    TotalAvaliacoes = table.Column<int>(type: "integer", nullable: false),
                    MediaNotaUtilizadores = table.Column<decimal>(type: "numeric", nullable: false),
                    MediaNotaCriticos = table.Column<decimal>(type: "numeric", nullable: false),
                    JogoId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
